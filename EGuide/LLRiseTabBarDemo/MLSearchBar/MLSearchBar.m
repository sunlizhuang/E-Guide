...
#define DefulatBorderColor [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0].CGColor
#define DefulatTintColor [UIColor colorWithRed:44/255.0 green:122/255.0 blue:255/255.0 alpha:1.0];
#define DefulatPlacehoderString @""
...
- (void)setupWithFrame:(CGRect)frame
{
    ...
    self.layer.borderColor = DefulatBorderColor;
